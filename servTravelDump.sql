...
--
-- Host: localhost    Database: fabiserv_travelbook_db
-- ------------------------------------------------------
...
CREATE TABLE `friends` (
  ...
  `friend_name1` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `friend_id2` int(6) DEFAULT NULL,
  `friend_name2` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `users` (
  ...
  `user_name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2019-09-19 10:46:17
